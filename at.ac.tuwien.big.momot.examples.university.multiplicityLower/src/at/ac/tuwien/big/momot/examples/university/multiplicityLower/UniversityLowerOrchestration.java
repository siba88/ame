package at.ac.tuwien.big.momot.examples.university.multiplicityLower;
...
public class UniversityLowerOrchestration {
	
private static final String MODEL_EXTENSION = ".xmi";
	
	private static final String RULES = "university_multiplicityLower.henshin";
	...
	private static final String RULE_ASSIGNSTUDENT_ID = "assignCourse.id";
	private static final String RULE_ASSIGNSTUDENT_COURSE = "assignCourse.cId";
...
//		experiment.addExecutor("EpsilonMOEA", evolutionaryExecutor.createEpsilonMOEAExecutor(0.05));
	...
	public static void main(String[] args) throws IOException {	
		repairModel("University_multiplicityLower.xmi", 1);
	}
