package at.ac.tuwien.big.momot.examples.university.multiplicityUpper;
...
public class UniversityUpperOrchestration {
	
private static final String MODEL_EXTENSION = ".xmi";
	
	private static final String RULES = "University_multiplicityUpper.henshin";
	private static final String MODEL_DIRECTORY = "model/";
	private static final String OUTPUT_DIRECTORY = "output/";

	private static final String RULE_DELETESTUDENT_ID = "deleteStudentFromCourse.id";
	private static final String RULE_DELETESTUDENT_COURSE = "deleteStudentFromCourse.cId";
	...
	public static MomotOrchestration createOrchestration(String initialModel) {
		...
		orchestration.getParameterManager().preserveParameters(
				RULE_DELETESTUDENT_ID,
				RULE_DELETESTUDENT_COURSE
		);
...
//		experiment.addExecutor("EpsilonMOEA", evolutionaryExecutor.createEpsilonMOEAExecutor(0.05));
	...
	public static void main(String[] args) throws IOException {	
		repairModel("University_multiplicityUpper.xmi", 1);
	}
