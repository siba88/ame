...
public class UniversityOrchestration {
	...
	private static final String RULE_ASSIGNPROFESSOR_COURSE = "assignProfessor.course";
	private static final String RULE_ASSIGNPROFESSOR_NAME = "assignProfessor.name";
	
	private static final String RULE_CREATECOURSE_VALUE = "createCourse.value";
	private static final String RULE_CREATECOURSE_CVALUE = "createCourse.cvalue";
	
	private static final String RULE_CREATEPROFESSOR_VALUE = "createProfessor.value";
	private static final String RULE_CREATEPROFESSOR_CVALUE = "createProfessor.cvalue";
	
	private static final String RULE_DELETEPROFESSOR_DELNAME = "deleteProfessor.delname";
	...
	public static MomotOrchestration createOrchestration(String initialModel) {
		...
		orchestration.getParameterManager().preserveParameters(
				RULE_ASSIGNPROFESSOR_COURSE,
				RULE_ASSIGNPROFESSOR_NAME,
				RULE_CREATEPROFESSOR_VALUE,
				RULE_CREATEPROFESSOR_CVALUE,
				RULE_CREATECOURSE_VALUE,
				RULE_CREATECOURSE_CVALUE,
				RULE_DELETEPROFESSOR_DELNAME
		);
...
/*		orchestration.getParameterManager().setParameterValue(
	...
	public static void main(String[] args) throws IOException {	
		repairModel("university_professors.xmi", 1);
	}
}
