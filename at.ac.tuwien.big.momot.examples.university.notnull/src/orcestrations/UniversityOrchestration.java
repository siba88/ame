...
import at.ac.tuwien.big.momot.rule.parameter.random.RandomStringParameterValue;
...
public class UniversityOrchestration {
	...
	private static final String RULE_FIXPROFESSORNAMES_NAME = "fixProfessorNames.name";
	private static final String RULE_FIXPROFESSORNAMES_NEWNAME = "fixProfessorNames.newName";
	...
	public static MomotOrchestration createOrchestration(String initialModel) {
		...
		orchestration.getParameterManager().preserveParameters(
				...
				RULE_FIXPROFESSORNAMES_NAME,
				RULE_FIXPROFESSORNAMES_NEWNAME
		);
